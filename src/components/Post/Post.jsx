...
const Post = ({ postId }) => {
    ...
    const handleUpdateLike = async () => {
        ...
        const result = await handlePutMethod(url, { userId })
    ...
    const handleUpdateUnLike = async () => {
        const url = `https://my-classroom-server.onrender.com/api/v1/posts/unlike/${post._id}`;
        const userId = user.uid;
        const result = await handleDeleteMethod(url, { userId });
        setLikeResult(result)
        setIsLiked(false)
    }
            ...
            <div className='flex flex-col items-start gap-2'>
                ...
                <div className=''>
                    <div className='flex flex-col'>
                        ...
                        <div className='my-1'>
                            <div className='p-4 text-sm bg-slate-300 rounded-md'>
                        ...
                        <div className='flex flex-row justify-end gap-2 items-center'>
                            {
                                (isLiked) ? <button onClick={() => handleUpdateUnLike()} className='flex flex-row gap-1 rounded-lg p-2 items-center justify-center  bg-slate-200'>
                                    <svg
                                    ...
                                    <span>unlike</span>
                                </button> : <button onClick={() => handleUpdateLike()} className='flex flex-row gap-1 rounded-lg p-2 items-center justify-center  bg-slate-200'>
                                    <svg
                                        className='inline'
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="16"
