...
const UpdateLike = () => {
    ...
    return (
        <>{(isLiked) ? <button onClick={() => handleUpdateLike('false')} className='p-2 rounded-lg bg-indigo-300'>
            <svg
        ...
        </button> : <button onClick={() => handleUpdateLike('true')} className='p-2 rounded-lg bg-indigo-300'>
            <svg
                className=''
                xmlns="http://www.w3.org/2000/svg"
                width="16"
