...
const Comment = ({ setComments, setCommentCount, comment }) => {
    ...
    return (
        <div className=' my-2 border relative p-1 rounded-md '>
            ...
            <div className='bg-indigo-300 p-2 rounded-md'>
                <CommentInfo comment={comment}></CommentInfo>
                <div className='flex flex-row gap-2 justify-end'>
                    <button className='flex justify-end gap-1 p-1 items-center  rounded-md bg-indigo-400 hover:bg-indigo-500'>
                        <svg
                            className='inline'
                    ...
                    <button
                        ...
                        className='flex flex-row items-center gap-2 rounded-r-md p-1 outline-0 rounded-md bg-indigo-400 hover:bg-indigo-500'>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
                            height="16"
